...
public class Jikai {
    ...
    private final BotData bd;
    private final Map<TitleLanguage, AnimeListHandler> alhs = new HashMap<>();
    private final Map<String, BigListHandler> blhs = new HashMap<>();
    ...
    private boolean sendToOwner(String msg) {
        ...
        try {
            ...
            BotUtils.sendPMChecked(owner, String.format("Greetings, %s!\n%s", owner, msg));
            MDC.remove("id");
            return true;
        } catch (Exception e) {
