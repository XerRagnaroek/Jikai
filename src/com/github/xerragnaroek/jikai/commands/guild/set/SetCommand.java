...
public class SetCommand implements GuildCommand {
    ...
    public void executeCommand(MessageReceivedEvent event, String[] arguments) {
        if (arguments.length >= 1) {
            ...
            if (c != null) {
                ...
                arguments = ArrayUtils.subarray(arguments, 1, arguments.length);
    ...
    public String getDescription(JikaiLocale loc) {
        return loc.getStringFormatted("com_g_set_desc", List.of("coms"), setComs.stream().map(com -> "**" + com.getName() + "** <value>" + ":\n" + com.getDescription(loc)).collect(Collectors.joining("\n")));
    }
