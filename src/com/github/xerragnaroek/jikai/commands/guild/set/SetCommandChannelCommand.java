...
public class SetCommandChannelCommand implements GuildCommand {
    ...
    public String getUsage(JikaiLocale loc) {
        return loc.getStringFormatted("com_g_set_com_use", List.of("com"), getName());
    }
    ...
    public void executeCommand(MessageReceivedEvent event, String[] arguments) {
        ...
        if (arguments.length >= 1) {
            ...
            if (!tcs.isEmpty()) {
                ...
                textC.sendMessage(j.getLocale().getStringFormatted("com_g_set_com_fail", List.of("channel"), arguments[0])).queue();
                return;
            }
        }
        ...
        try {
            j.getInfoChannel().sendMessage(j.getLocale().getStringFormatted("com_g_set_com_success", List.of("channel"), textC.getAsMention())).queue();
