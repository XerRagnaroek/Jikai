...
public class TestCommand implements JUCommand, GuildCommand {
    ...
    public void executeCommand(JikaiUser ju, String[] arguments) {
        ...
        ju.sendPM(BotUtils.titledEmbed(loc.getString("ju_eb_ani_auth_title"), loc.getStringFormatted("ju_eb_ani_auth_rev_auto", List.of("link"), JikaiUserAniTokenManager.getOAuthUrl()))).thenAccept(b -> log.debug("Sent invalid token embed to user {} {}", ju.getAniId(), b));
    ...
    public void executeCommand(MessageReceivedEvent event, String[] arguments) {
         ...
         */
        AnimeListHandler alh = new AnimeListHandler(event.getGuild().getIdLong(), event.getChannel().asTextChannel());
