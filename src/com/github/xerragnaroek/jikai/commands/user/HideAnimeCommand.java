    ...
    public void executeCommand(JikaiUser ju, String[] arguments) {
        ...
        if (arguments.length < 1) {
            ...
            try {
                ...
                if (a == null) {
                    ju.sendPM(loc.getStringFormatted("com_ju_hide_anime_invalid", List.of("input"), id));
                    return;
                }
                ...
                if (a == null) {
                    ju.sendPM(loc.getStringFormatted("com_ju_hide_anime_invalid", List.of("input"), title));
                    return;
                }
            }
            if (a != null) {
                ...
                if (ju.isHiddenAnime(a.getId())) {
                    ...
                    eb.setDescription(loc.getStringFormatted("com_ju_hide_anime_eb_desc_unhidden", List.of("title"), (ju.hasCustomTitle(a.getId()) ? ju.getCustomTitle(a.getId()) : a.getTitle(ju.getTitleLanguage()))));
                } else {
                    ju.hideAnimeFromLists(a.getId());
                    eb.setDescription(loc.getStringFormatted("com_ju_hide_anime_eb_desc_hidden", List.of("title"), (ju.hasCustomTitle(a.getId()) ? ju.getCustomTitle(a.getId()) : a.getTitle(ju.getTitleLanguage()))));
                }
                ju.sendPM(eb.build());
            }
        }
