...
public class Schedule {
    ...
    private final Map<DayOfWeek, Map<LocalTime, List<Anime>>> week = new ConcurrentHashMap<>();
    private LocalDate monDate;
    private final ZoneId zone;
    private final SelfResettingFlagProperty changed = new SelfResettingFlagProperty();
