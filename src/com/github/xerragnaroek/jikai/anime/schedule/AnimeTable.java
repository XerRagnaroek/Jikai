...
public class AnimeTable {
    ...
    private final String fontFile = "animeace_b.ttf";
    private final Color backgroundCol = new Color(54, 57, 63);
...
class Cell implements Comparable<Cell> {
    ...
    private final TreeMap<Anime, BufferedImage> ani = new TreeMap<>();
