...
public class AniListSyncer {
    ...
    private final Map<Integer, Set<JikaiUser>> userMap = Collections.synchronizedMap(new HashMap<>());
    ...
    public void syncSubsWithAniList(JikaiUser ju) throws AniException, IOException {
        ...
        AnimeDB.getJASA().fetchUserListEntries(List.of(ju.getAniId()), MediaListStatus.PLANNING, MediaListStatus.CURRENT).filter(ule -> ule.getMediaStatus() != null && !ule.getMediaStatus().equals("FINISHED")).forEach(this::handleUserListEntry);
    }
