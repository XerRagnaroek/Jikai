...
public class AnimeUpdate {
    ...
    private final List<Anime> removed = new LinkedList<>();
    private List<Anime> removedFiltered;
    private List<Anime> newAnime;
    private List<Anime> newAnimeFiltered;
    private final List<Pair<Anime, Long>> changed = new LinkedList<>();
    private List<Pair<Anime, Long>> changedFiltered;
    private final List<Anime> nextEp = new ArrayList<>();
    private List<Anime> nextEpFiltered;
    private final List<Anime> removedButStillValid = new LinkedList<>();
    ...
    private final List<Anime> infoChanged = new LinkedList<>();
