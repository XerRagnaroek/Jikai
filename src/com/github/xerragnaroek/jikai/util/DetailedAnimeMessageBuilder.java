...
public class DetailedAnimeMessageBuilder {
	...
	private JikaiLocale loc;
	private boolean ignoreEmpty;
	private static DateTimeFormatter formatFull = DateTimeFormatter.ofPattern("dd MMMM, yyyy");
	private static DateTimeFormatter format = DateTimeFormatter.ofPattern("MMMM yyyy");
	private ZoneId zone;
	...
	private void addField(String locKey, boolean inline, String format, String replace) {
		...
		String val = loc.getStringFormatted(locKey + "_v", Arrays.asList(format), replace);
